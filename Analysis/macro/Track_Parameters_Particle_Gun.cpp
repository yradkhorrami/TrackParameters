...
char particle_pion[par_pion.size() + 1];
strcpy(particle_pion, par_pion.c_str());
char anti_particle_Apion[apar_Apion.size() + 1];
strcpy(anti_particle_Apion, apar_Apion.c_str());
...
TH1* hist_momentum = new TH1F("hist_momentum", "; p [GeV]; # tracks" , 100,0,40);
hist_momentum->SetLineColor(4); hist_momentum->SetLineWidth(1);
TH1* hist_momentum_Par = new TH1F("hist_momentum_Par", "; p [GeV]; # tracks" , 100,0,40);
hist_momentum_Par->SetLineColor(1); hist_momentum_Par->SetLineWidth(1);
TH1* hist_momentum_aPar = new TH1F("hist_momentum_aPar", "; p [GeV]; # tracks" , 100,0,40);
...
TH1* hist_pull_d0_pion_mass_Par = new TH1F("hist_pull_d0_pion_mass_Par", "; d_{0} Pull; # tracks" , 100,pull_min,pull_max);
hist_pull_d0_pion_mass_Par->SetLineColor(15); hist_pull_d0_pion_mass_Par->SetLineWidth(1);
TH1* hist_pull_d0_pion_mass_aPar = new TH1F("hist_pull_d0_pion_mass_aPar", "; d_{0} Pull; # tracks" , 100,pull_min,pull_max);
hist_pull_d0_pion_mass_aPar->SetLineColor(8); hist_pull_d0_pion_mass_aPar->SetLineWidth(1);
...
TH1* hist_pull_Omega_pion_mass_Par = new TH1F("hist_pull_Omega_pion_mass_Par", "; Omega pull; # tracks" , 100,pull_min,pull_max);
hist_pull_Omega_pion_mass_Par->SetLineColor(15); hist_pull_Omega_pion_mass_Par->SetLineWidth(1);
TH1* hist_pull_Omega_pion_mass_aPar = new TH1F("hist_pull_Omega_pion_mass_aPar", "; Omega pull; # tracks" , 100,pull_min,pull_max);
hist_pull_Omega_pion_mass_aPar->SetLineColor(8); hist_pull_Omega_pion_mass_aPar->SetLineWidth(1);
...
TH1* hist_pull_Phi_pion_mass_Par = new TH1F("hist_pull_Phi_pion_mass_Par", "; Phi pull; # tracks" , 100,pull_min,pull_max);
hist_pull_Phi_pion_mass_Par->SetLineColor(15); hist_pull_Phi_pion_mass_Par->SetLineWidth(1);
TH1* hist_pull_Phi_pion_mass_aPar = new TH1F("hist_pull_Phi_pion_mass_aPar", "; Phi pull; # tracks" , 100,pull_min,pull_max);
hist_pull_Phi_pion_mass_aPar->SetLineColor(8); hist_pull_Phi_pion_mass_aPar->SetLineWidth(1);
...
for (int i = 0; i < nEntries; i++)
{
	...
	for (int track_i = 0; track_i < (track_PDG->size()); track_i++)
	{
		if ((vertex_radius->at(track_i) >= r_cut) || (vertex_rho->at(track_i) >= rho_cut) || (highest_weight->at(track_i) < weight_cut) || abs(track_PDG->at(track_i)) != true_pdg)
			continue;
/*
		if (rec_d0_true_mass->at(track_i) * mcp_d0->at(track_i) >=0)
			continue;
*/
		...
		if (momentum->at(track_i) >= p_min && momentum->at(track_i) <= p_max)
		{
			...
			if (track_PDG->at(track_i) == true_pdg)
			{
				...
				hist_pull_d0_pion_mass_Par->Fill(pull_d0_pion_mass->at(track_i));
				hist_pull_Omega_pion_mass_Par->Fill(pull_Omega_pion_mass->at(track_i));
				hist_pull_Phi_pion_mass_Par->Fill(pull_Phi_pion_mass->at(track_i));
			}
			...
			if (track_PDG->at(track_i) == -1 * true_pdg)
			{
				...
				hist_pull_d0_pion_mass_aPar->Fill(pull_d0_pion_mass->at(track_i));
				hist_pull_Omega_pion_mass_aPar->Fill(pull_Omega_pion_mass->at(track_i));
				hist_pull_Phi_pion_mass_aPar->Fill(pull_Phi_pion_mass->at(track_i));
			}
		}
	}
}
...
TLegend *leg_residual_d0=new TLegend(X1,2 * Y1 - Y2 - 0.15,X2,2 * Y1 - Y2);
...
TLegend *leg_residual_Omega=new TLegend(X1,2 * Y1 - Y2 - 0.15,X2,2 * Y1 - Y2);
...
TLegend *leg_residual_Phi=new TLegend(X1,2 * Y1 - Y2 - 0.15,X2,2 * Y1 - Y2);
...
TLegend *leg_residual_tanLambda=new TLegend(X1,2 * Y1 - Y2 - 0.15,X2,2 * Y1 - Y2);
...
TLegend *leg_residual_z0=new TLegend(X1,2 * Y1 - Y2 - 0.15,X2,2 * Y1 - Y2);
...
tps_uncertainty_d0_true_mass_Par->SetX1NDC(2*X1-X2); tps_uncertainty_d0_true_mass_Par->SetX2NDC(X1); tps_uncertainty_d0_true_mass_Par->SetY1NDC(Y1); tps_uncertainty_d0_true_mass_Par->SetY2NDC(Y2);
tps_uncertainty_d0_true_mass_aPar->SetX1NDC(2*X1-X2); tps_uncertainty_d0_true_mass_aPar->SetX2NDC(X1); tps_uncertainty_d0_true_mass_aPar->SetY1NDC(Y1-(Y2-Y1)); tps_uncertainty_d0_true_mass_aPar->SetY2NDC(Y1);
...
TLegend *leg_uncertainty_d0=new TLegend(X1,2 * Y1 - Y2 - 0.15,X2,2 * Y1 - Y2);
...
tps_uncertainty_Omega_true_mass_Par->SetX1NDC(2*X1-X2); tps_uncertainty_Omega_true_mass_Par->SetX2NDC(X1); tps_uncertainty_Omega_true_mass_Par->SetY1NDC(Y1); tps_uncertainty_Omega_true_mass_Par->SetY2NDC(Y2);
tps_uncertainty_Omega_true_mass_aPar->SetX1NDC(2*X1-X2); tps_uncertainty_Omega_true_mass_aPar->SetX2NDC(X1); tps_uncertainty_Omega_true_mass_aPar->SetY1NDC(Y1-(Y2-Y1)); tps_uncertainty_Omega_true_mass_aPar->SetY2NDC(Y1);
...
TLegend *leg_uncertainty_Omega=new TLegend(X1,2 * Y1 - Y2 - 0.15,X2,2 * Y1 - Y2);
...
tps_uncertainty_Phi_true_mass_Par->SetX1NDC(2*X1-X2); tps_uncertainty_Phi_true_mass_Par->SetX2NDC(X1); tps_uncertainty_Phi_true_mass_Par->SetY1NDC(Y1); tps_uncertainty_Phi_true_mass_Par->SetY2NDC(Y2);
tps_uncertainty_Phi_true_mass_aPar->SetX1NDC(2*X1-X2); tps_uncertainty_Phi_true_mass_aPar->SetX2NDC(X1); tps_uncertainty_Phi_true_mass_aPar->SetY1NDC(Y1-(Y2-Y1)); tps_uncertainty_Phi_true_mass_aPar->SetY2NDC(Y1);
...
TLegend *leg_uncertainty_Phi=new TLegend(X1,2 * Y1 - Y2 - 0.15,X2,2 * Y1 - Y2);
...
tps_uncertainty_tanLambda_true_mass_Par->SetX1NDC(2*X1-X2); tps_uncertainty_tanLambda_true_mass_Par->SetX2NDC(X1); tps_uncertainty_tanLambda_true_mass_Par->SetY1NDC(Y1); tps_uncertainty_tanLambda_true_mass_Par->SetY2NDC(Y2);
tps_uncertainty_tanLambda_true_mass_aPar->SetX1NDC(2*X1-X2); tps_uncertainty_tanLambda_true_mass_aPar->SetX2NDC(X1); tps_uncertainty_tanLambda_true_mass_aPar->SetY1NDC(Y1-(Y2-Y1)); tps_uncertainty_tanLambda_true_mass_aPar->SetY2NDC(Y1);
...
TLegend *leg_uncertainty_tanLambda=new TLegend(X1,2 * Y1 - Y2 - 0.15,X2,2 * Y1 - Y2);
...
tps_uncertainty_z0_true_mass_Par->SetX1NDC(2*X1-X2); tps_uncertainty_z0_true_mass_Par->SetX2NDC(X1); tps_uncertainty_z0_true_mass_Par->SetY1NDC(Y1); tps_uncertainty_z0_true_mass_Par->SetY2NDC(Y2);
tps_uncertainty_z0_true_mass_aPar->SetX1NDC(2*X1-X2); tps_uncertainty_z0_true_mass_aPar->SetX2NDC(X1); tps_uncertainty_z0_true_mass_aPar->SetY1NDC(Y1-(Y2-Y1)); tps_uncertainty_z0_true_mass_aPar->SetY2NDC(Y1);
...
TLegend *leg_uncertainty_z0=new TLegend(X1,2 * Y1 - Y2 - 0.15,X2,2 * Y1 - Y2);
...
TLegend *leg_momentum = new TLegend(X1,2 * Y1 - Y2 - 0.15,X2,2 * Y1 - Y2);
...
hist_pull_Phi_pion_mass->Draw("sames");
hist_pull_Phi_true_mass_Par->Draw("sames");
hist_pull_Phi_true_mass_aPar->Draw("sames");
hist_pull_Phi_pion_mass_Par->Draw("sames");
hist_pull_Phi_pion_mass_aPar->Draw("sames");
...
hist_pull_Phi_pion_mass_Par->Fit("gaus","","",fit_min,fit_max); hist_pull_Phi_pion_mass_Par->GetFunction("gaus")->SetLineColor(15); hist_pull_Phi_pion_mass_Par->GetFunction("gaus")->SetLineStyle(2); hist_pull_Phi_pion_mass_Par->GetFunction("gaus")->SetLineWidth(1);
hist_pull_Phi_pion_mass_aPar->Fit("gaus","","",fit_min,fit_max); hist_pull_Phi_pion_mass_aPar->GetFunction("gaus")->SetLineColor(8); hist_pull_Phi_pion_mass_aPar->GetFunction("gaus")->SetLineStyle(2); hist_pull_Phi_pion_mass_aPar->GetFunction("gaus")->SetLineWidth(1);
...
TPaveStats *tps_pull_Phi_pion_mass_Par = (TPaveStats*)hist_pull_Phi_pion_mass_Par->FindObject("stats");
TPaveStats *tps_pull_Phi_pion_mass_aPar = (TPaveStats*)hist_pull_Phi_pion_mass_aPar->FindObject("stats");
...
tps_pull_Phi_pion_mass_Par->SetTextColor(15); tps_pull_Phi_pion_mass_Par->SetLineColor(15);
tps_pull_Phi_pion_mass_aPar->SetTextColor(8); tps_pull_Phi_pion_mass_aPar->SetLineColor(8);
...
tps_pull_Phi_true_mass_Par->SetX1NDC(1-X2+0.1); tps_pull_Phi_true_mass_Par->SetX2NDC(1-X1+0.1); tps_pull_Phi_true_mass_Par->SetY1NDC(Y1-(Y2-Y1)); tps_pull_Phi_true_mass_Par->SetY2NDC(Y1);
tps_pull_Phi_true_mass_aPar->SetX1NDC(1-X2+0.1); tps_pull_Phi_true_mass_aPar->SetX2NDC(1-X1+0.1); tps_pull_Phi_true_mass_aPar->SetY1NDC(Y1-2*(Y2-Y1)); tps_pull_Phi_true_mass_aPar->SetY2NDC(Y1-(Y2-Y1));
tps_pull_Phi_pion_mass_Par->SetX1NDC(X1); tps_pull_Phi_pion_mass_Par->SetX2NDC(X2); tps_pull_Phi_pion_mass_Par->SetY1NDC(Y1-(Y2-Y1)); tps_pull_Phi_pion_mass_Par->SetY2NDC(Y1);
tps_pull_Phi_pion_mass_aPar->SetX1NDC(X1); tps_pull_Phi_pion_mass_aPar->SetX2NDC(X2); tps_pull_Phi_pion_mass_aPar->SetY1NDC(Y1-2*(Y2-Y1)); tps_pull_Phi_pion_mass_aPar->SetY2NDC(Y1-(Y2-Y1));
...
tps_pull_Phi_pion_mass_Par->Draw("same");
tps_pull_Phi_pion_mass_aPar->Draw("same");
TLegend *leg_pull_Phi=new TLegend(X1,3 * Y1 - 2 * Y2 - 0.15,X2,3 * Y1 - 2 * Y2);
...
leg_pull_Phi->AddEntry(hist_pull_Phi_pion_mass_Par,particle_pion,"l");
leg_pull_Phi->AddEntry(hist_pull_Phi_pion_mass_aPar,anti_particle_Apion,"l");
...
hist_pull_tanLambda_true_mass->Draw();
hist_pull_tanLambda_pion_mass->Draw("sames");
...
TLegend *leg_pull_tanLambda=new TLegend(X1,2 * Y1 - Y2 - 0.15,X2,2 * Y1 - Y2);
...
hist_pull_z0_true_mass->Draw();
hist_pull_z0_pion_mass->Draw("sames");
...
TLegend *leg_pull_z0=new TLegend(X1,2 * Y1 - Y2 - 0.15,X2,2 * Y1 - Y2);
